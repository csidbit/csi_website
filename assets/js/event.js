  ...
  var bookList = function(element) {
    ...
    this.shuffle = new Shuffle(element, {
      itemSelector: '.event-grid-container',
    });
  ...
  bookList.prototype._handleSearchKeyup = function(evt) {
    ...
    this.shuffle.filter(function(element, shuffle) {
      ...
      var titleElement = element.querySelector('.events-grid-content-details-title');
  ...
  document.addEventListener('DOMContentLoaded', function() {
    window.book_list = new bookList(document.getElementById('events-eve'));
  });